...
dprobit unemployed_wk educ_group_dummy2 educ_group_dummy3 educ_group_dummy4 educ_group_dummy5 exp male race_dummy1 race_dummy3 race_dummy4 race_dummy5 if (age>=18 & age<=64) & (occupied_wk!=1) & (search_job_1m==1) & out_of_LF_wk!=1 & pbf_or_caduni==`i' [pweight=per_weight]
...
*VI ALL 
dprobit unemployed_wk educ exp male race_dummy1 race_dummy3 race_dummy4 race_dummy5 urban state_group_dummy2 state_group_dummy4 state_group_dummy5 state_group_dummy6 occ_3581_group_dummy3 occ_3581_group_dummy4 occ_3581_group_dummy5 occ_3581_group_dummy6 job_search_network_dummy1 job_search_network_dummy3 job_search_network_dummy4 job_search_network_dummy5 job_search_network_dummy6 job_search_network_dummy7 job_search_network_dummy8 job_search_network_dummy9 hh_nchild mom_lives_in_hh dom_aff_wk if (age>=18 & age<=64) & (occupied_wk!=1) & (search_job_1m==1) & out_of_LF_wk!=1 & pbf_or_caduni==`i' [pweight=per_weight]
...
*II SUPPLY but with educ_groups + exp
reg job_duration_wk educ_group_dummy2 educ_group_dummy3 educ_group_dummy4 educ_group_dummy5 exp male race_dummy1 race_dummy3 race_dummy4 race_dummy5 if (age>=18 & age<=64) & job_duration_wk<=180 & pbf_or_caduni==`i' [pweight=per_weight], r 
...
*VI ALL 
reg job_duration_wk educ exp male race_dummy1 race_dummy3 race_dummy4 race_dummy5 urban state_group_dummy2 state_group_dummy4 state_group_dummy5 state_group_dummy6 occ_3581_group_dummy3 occ_3581_group_dummy4 occ_3581_group_dummy5 occ_3581_group_dummy6 job_search_network_dummy1 job_search_network_dummy3 job_search_network_dummy4 job_search_network_dummy5 job_search_network_dummy6 job_search_network_dummy7 job_search_network_dummy8 job_search_network_dummy9 comm_time_wk_dummy2 comm_time_wk_dummy3 comm_time_wk_dummy4 hh_nchild mom_lives_in_hh dom_aff_wk if (age>=18 & age<=64) & job_duration_wk<=180 & pbf_or_caduni==`i' [pweight=per_weight], r 
